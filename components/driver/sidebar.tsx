...
export function DriverSidebar() {
  ...
  const links = [
    ...
    { href: '/driver/availability', label: 'Availability', icon: '✅' },
    { href: '/driver/ride-request', label: 'Ride Requests', icon: '📲' },
    { href: '/driver/active-ride', label: 'Active Ride', icon: '🚗' },
  ...
  return (
    <aside className="w-64 bg-gray-900 text-white min-h-screen flex flex-col">
      ...
      <div className="p-6 border-b border-gray-800">
        ...
        <p className="text-xs text-gray-400 mt-2">Driver Portal</p>
      </div>
